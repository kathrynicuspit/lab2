...
<body>
	...
	<div class="content">
		...
		<div class ="newslatter">
			<form>
				<input type="email" name="email" id="mail" placeholder="Enter Your Email (eme lang itu) ">
...
<h2>Object from JSON String</h2>

<p id="demo4"></p>

<script>
let text = '{"family":[' +
'{"firstName":"Mary","lastName":"Icuspit" },' +
'{"firstName":"Clinton","lastName":"Icuspit" },' +
'{"firstName":"Kristelle","lastName":"Valmonte" }]}';
'{"firstName":"Christian","lastName":"Icuspit" }]}';


const obj = JSON.parse(text);
document.getElementById("demo4").innerHTML =
obj.family[1].firstName + " " + obj.family[1].lastName;
</script>
...
function myFirst() {
  myDisplayer("Hello, website is under maintainance");
}

function mySecond() {
  myDisplayer("Please be patient!");
}
